...
ComputeTemperatureFiniteDifferences::ComputeTemperatureFiniteDifferences(System& system, Real dt) : dt(dt) {
...
Matrix<complex> ComputeTemperatureFiniteDifferences::computeDerivative(System& system) {
